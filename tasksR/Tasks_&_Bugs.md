...
- [ ] **Flujo de negocio del paquete: MP→Línea→Paletizado→Out→fin** — DESBLOQUEADO 4-sep tras corrección del layout (OUT real en (530,200)→X_M02). EN CURSO (Antigravity; si no responde, rota a Deep).
